  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto py-7 px-4 md:px-8 lg:px-10">
        <h2 className="text-lg md:text-4xl mb-4 font-bold text-xl dark:text-white max-w-4xl">
          Your Trip Itinerary from <strong className="text-[#444ce7]">{trip_data?.source}</strong> to<strong className="text-[#444ce7]"> {trip_data?.destination} </strong> is Ready
        </h2>
       <div className="flex gap-5 item-center">
         <div className="flex gap-2 item-center">
          <Calendar/>
            <h2>{trip_data.duration}</h2>
         </div>
         <div className="flex gap-2 item-center">
          <Wallet2/>
            <h2>{trip_data.budget}</h2>
         </div>
         <div className="flex gap-2 item-center">
          <Users/>
            <h2>{trip_data.group_size}</h2>
         </div>
       </div>
      </div>
