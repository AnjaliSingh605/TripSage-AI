...
const ChatBox = () => {
  ...
  return (
    // Use min-h-0 so flex children can shrink properly on mobile
    <div className='h-[85vh] flex flex-col border shadow rounded-2xl p-5 min-h-0'>

      {/* Scrollable message area — takes all available space */}
      <section className='flex-1 overflow-y-auto p-4 min-h-0' ref={messageContainerRef}>

        {/* EmptyBoxState scrolls with messages, doesn't push textarea */}
      ...
      {/* Textarea — always pinned at bottom, never pushed off screen */}
      <section className='flex-shrink-0 mt-2'>
