...
const HowItWorks = () => {
  return (
    <div className="relative w-full py-16 md:py-20 px-5 md:px-10 lg:px-16 overflow-hidden bg-transparent font-sans">

      {/* Background Glow */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 
      w-[800px] h-[500px] bg-blue-600/10 blur-[120px] rounded-full pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto w-full relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <div className="h-1 w-40 bg-gradient-to-r from-blue-400 to-purple-500 
          mx-auto rounded-full shadow-[0_0_20px_rgba(96,165,250,0.5)]" />
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          p-7 md:p-10 backdrop-blur-md transition-all hover:bg-white/10 hover:border-blue-500/30
          hover:shadow-xl hover:shadow-blue-500/10">
            ...
            group-hover:text-blue-500/20 transition-all duration-500 blur-xl" />
          </div>

          {/* Feature Card 2 */}
          <div className="group relative overflow-hidden rounded-3xl border border-white/10 bg-white/5 
          p-7 md:p-10 backdrop-blur-md transition-all hover:bg-white/10 hover:border-purple-500/30
          hover:shadow-xl hover:shadow-purple-500/10">
            ...
            <Brain className="absolute -right-4 -bottom-4 w-32 h-32 text-purple-500/10 
            group-hover:text-purple-500/20 transition-all duration-500 blur-xl" />
          </div>
...
const StepCard = ({ number, title, description, icon }: any) => (
  <div className="group relative p-6 md:p-8 rounded-3xl border border-white/10 bg-white/5 
  backdrop-blur-sm transition-all duration-300 hover:-translate-y-2 hover:bg-white/10
  hover:shadow-xl hover:shadow-blue-500/10">
    ...
    <div className="flex items-center justify-between mb-6">
      ...
      <div className="flex items-center gap-3 md:gap-4">
        ...
        <div className="flex flex-col">
          ...
          <span className="mt-2 h-[1px] w-full bg-white/40 
          group-hover:bg-indigo-400 transition-all duration-300"></span>
        </div>
...
const FeatureItem = ({ text }: { text: string }) => (
  <li className="flex items-center gap-3">
    ...
    <div className="flex-shrink-0 w-5 h-5 rounded-full bg-blue-500/20 
